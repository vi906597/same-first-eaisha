...
const funds = [
  ...
  { name: "Mirae Asset Emerging", category: "Large & Mid", returns1y: "22.1%", returns3y: "17.8%", risk: "Medium" },
  ...
  { name: "HDFC Mid-Cap Opp.", category: "Mid Cap", returns1y: "24.6%", returns3y: "19.4%", risk: "Medium" },
];
    ...
    <section className="py-24 px-6 bg-background">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground text-lg">India ke sabse behtareen mutual funds</p>
        </motion.div>
